...
var KTAuthI18nDemo = function() {
    var e, n, a = {
        ...
        "general-desc": {
            English: "Join haloCRM, your companion in spiritual Journey",
            Spanish: "Únete a haloCRM, tu compañero en el viaje espiritual",
            German: "Treten Sie haloCRM bei, Ihr Begleiter auf der spirituellen Reise",
            Japanese: "haloCRMに参加し、あなたの精神的な旅の仲間になりましょう",
            French: "Rejoignez haloCRM, votre compagnon dans le voyage spirituel"
        },
            "general-or": {
            English: "Or",
            Spanish: "O",
    ...
    return {
        init: function() {
            if ((e = document.querySelector("#kt_auth_lang_menu")) !== null) {
