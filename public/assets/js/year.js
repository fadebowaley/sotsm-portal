...
yearBecameWorkerOptions = yearBecameWorkerOptions.slice().reverse();
...
// Identify all select elements with the class name "worker-select"
const selectElements = document.querySelectorAll('.worker-select');

// Populate each select element with options
selectElements.forEach(select => {
    populateSelect(select, yearBecameWorkerOptions);
});