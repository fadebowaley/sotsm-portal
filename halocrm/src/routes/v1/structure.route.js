...
const structureValidation = require('../../validations/structure.validation');
 ...
 * tags:
 *   name: Structures
 *   description: Structure management and retrieval
 */
 ...
 *     description: Only admins can create structures.
 *     tags: [Structures]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *             example:
 *               name: MyStructure
 *               description: This is a sample structure
 *     responses:
 *       "201":
 *         description: Created
 *         content:
 ...
 *     description: Only admins can retrieve all structures.
 *     tags: [Structures]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *           minimum: 1
 *         default: 10
 *         description: Maximum number of structures
 *       - in: query
 *         name: page
 *         schema:
 *           type: integer
 ...
 *     description: Logged in users can fetch only their own structure information. Only admins can fetch other structures.
 *     tags: [Structures]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in users can only update their own structure information. Only admins can update other structures.
 *     tags: [Structures]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in users can delete only their own structures. Only admins can delete other structures.
 *     tags: [Structures]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *         $ref: '#/components/responses/NotFound'
 */
// TODO: Update other files to reflect changes for structure.route
